  ...
  return (
    <section className="mx-auto flex w-full max-w-[96rem] flex-col gap-8 px-6 pt-15 pb-16 sm:px-8 lg:px-10">
      <div className="grid gap-5 lg:grid-cols-[minmax(0,0.58fr)_minmax(0,0.42fr)] lg:items-end">
        <h1 className="max-w-7xl font-display text-5xl leading-[0.92] font-semibold tracking-[-0.06em] text-[var(--copy-strong)] sm:text-6xl lg:text-5xl">
          Bewirb dich als kreativer Kopf wenn Veo3 und Seedance dein täglich Brot ist.
        </h1>
