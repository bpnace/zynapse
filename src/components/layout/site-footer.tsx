...
export function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-[color:var(--line)] bg-black/20">
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-14 sm:px-8 lg:grid-cols-[minmax(0,0.45fr)_repeat(3,minmax(0,0.18fr))] lg:px-10">
