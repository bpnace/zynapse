    ...
    <>
      ...
      <span
        className={cn(
          ...
          showArrows &&
            "-translate-x-3 group-hover/button:translate-x-3 group-focus-visible/button:translate-x-3",
          className,
        )}
      >
        {children}
      ...
      <span
        className={cn(
          "pointer-events-none absolute top-1/2 left-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full opacity-0 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover/button:h-[24rem] group-hover/button:w-[24rem] group-hover/button:opacity-100 group-focus-visible/button:h-[24rem] group-focus-visible/button:w-[24rem] group-focus-visible/button:opacity-100",
          fillClassName,
        )}
      />
