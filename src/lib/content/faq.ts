...
export const marketingFaqItems = [
  {
    ...
    answer:
      "Zynapse Core leitet aus Zielgruppe, Produktnutzen und vorhandenem Material eine Hook-Hypothese ab. Der erste Frame bekommt eine Funktion: Aufmerksamkeit, Kontext, Proof oder Produktdetail.",
  },
  {
