...
export const campaignAngles: CampaignAngle[] = [
  {
    ...
    hooks: [
      ...
      "Weniger Produktions-Deadlines, mehr getestete Kreativvarianten",
  ...
  },
  {
    ...
    hooks: [
      ...
      "Creative Lead steuert Strategie, Studio skaliert die Ausführung",
  ...
  },
  {
    ...
    hooks: [
      ...
      "Kreativ-Testing ohne Creator-Sourcing-Schleife",
...
export const videoVariants: VideoVariantPreview[] = [
  ...
  { id: "v4", angle: "Rollenklarheit", hookTitle: "Der Creative Lead führt die Strategie", format: "9:16", length: "15s", objective: "Conversion" },
  ...
  { id: "v10", angle: "Studio-System", hookTitle: "Gebaut für den Ads-Export", format: "9:16", length: "14s", objective: "Conversion" },
